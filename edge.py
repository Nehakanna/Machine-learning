...
x_train_features = np.array([extract_edge_features(preprocess_image(img)) for img in x_train[:1000]])
x_test_features = np.array([extract_edge_features(preprocess_image(img)) for img in x_test[:200]])
...
print("Feature Extraction Method: Edge Detection")
